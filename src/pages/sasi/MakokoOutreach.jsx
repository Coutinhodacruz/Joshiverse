      ...
      <section className="hero flex flex-col lg:flex-row lg:flex-row-reverse items-center mb-4 lg:mb-14 bg-white relative">
        <div className="hero__image w-full lg:w-1/2 mb-4 lg:mb-0">
          <div className="image w-full mb-4 lg:mb-8">
            <img src={somalia} alt="Somali mother holding her child while sat in front of a makeshift tent in an internally displaced persons camp" className="w-full h-auto mt-16 lg:mb-8" />
          </div>
        
          <div className="image-slider w-full flex justify-center lg:justify-start">
            <img src={somalia} alt="Somali mother holding her child" className="w-1/3 h-auto mr-2" />
            <img src={somalia} alt="Somali mother holding her child" className="w-1/3 h-auto" />
          </div>
