...
import jordan1 from "../../asset/images/image.png";
import jordan2 from "../../asset/images/1.jpg";
import jordan3 from "../../asset/images/jordan.jpg";
import Slider from "react-slick";
import Navbar from "./Navbar";
import {FaExpand, FaPlay, FaTimes, FaVolumeUp} from "react-icons/fa";
        ...
        <>
            ...
            <section className="bg-white mb-4 flex flex-col items-center md:flex-row md:items-center min-h-screen">
                <div className="flex flex-col w-full md:w-1/2 p-8 md:p-20 order-2 md:order-1">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-800 font-serif">Wesley outreach </h1>
            ...
            <section className="w-full p-8">
                <h2 className="text-2xl font-bold mb-4">Wesley outreach</h2>
